...
--   Date and Time:   01:40 Thursday April 17, 2014
...
,p_last_upd_yyyymmddhh24miss=>'20140417014000'
,p_ui_type_name => null
);
end;
/
...
wwv_flow_api.create_tab(
 p_id=>362380459821619991+wwv_flow_api.g_id_offset
,p_tab_set=>'TS1'
,p_tab_sequence=>70
,p_tab_name=>'Calendar'
,p_tab_text=>'Calendar'
...
,p_last_updated_by=>'GREGSTONT@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20140417012852'
);
...
wwv_flow_api.create_page_da_action(
 p_id=>362492184831810381+wwv_flow_api.g_id_offset
...
wwv_flow_api.create_page_da_action(
 p_id=>362498195106811735+wwv_flow_api.g_id_offset
,p_event_id=>359224698079878961+wwv_flow_api.g_id_offset
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>362493090564829573+wwv_flow_api.g_id_offset
,p_event_id=>359224698079878961+wwv_flow_api.g_id_offset
,p_event_result=>'TRUE'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'GREGSTONT@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20140417010709'
);
wwv_flow_api.create_calendar(
 p_id=>362379936923619989+wwv_flow_api.g_id_offset
,p_plug_name=>'Calendar'
,p_plug_source=>'select contract_id, beginning_date from BC_contract'
,p_plug_source_type=>'NATIVE_CALENDAR'
,p_plug_template=>350496976181139733+wwv_flow_api.g_id_offset
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
,p_plug_item_display_point=>'ABOVE'
,p_cal_id=>362380668346619993+wwv_flow_api.g_id_offset
,p_begin_at_start_of_interval=>'Y'
,p_date_item=>'P25_CALENDAR_DATE'
,p_display_as=>'M'
,p_display_item=>'P25_CALENDAR_DISPLAY'
,p_display_type=>'COL'
,p_date_column=>'BEGINNING_DATE'
,p_display_column=>'CONTRACT_ID'
,p_date_type_column=>'P25_CALENDAR_TYPE'
,p_end_date_item=>'P25_CALENDAR_END_DATE'
,p_include_custom_cal=>'N'
,p_custom_cal_days=>3
,p_item_link_open_in=>'W'
,p_include_time_with_date=>'N'
...
wwv_flow_api.create_page_button(
 p_id=>362381463739619996+wwv_flow_api.g_id_offset
,p_button_sequence=>10
,p_button_plug_id=>362379936923619989+wwv_flow_api.g_id_offset
,p_button_name=>'MONTHLY'
,p_button_action=>'REDIRECT_URL'
,p_button_template_id=>350501692613139741+wwv_flow_api.g_id_offset
,p_button_image_alt=>'Monthly'
,p_button_position=>'TOP'
,p_button_redirect_url=>'javascript:apex.widget.calendar.ajax_calendar(''M'',''same''); void(0);'
,p_button_condition=>'NVL(:P25_CALENDAR_TYPE, ''M'') <> ''M'''
,p_button_comment=>'Generated 04/17/2014'
);
wwv_flow_api.create_page_button(
 p_id=>362381691410619996+wwv_flow_api.g_id_offset
,p_button_sequence=>20
,p_button_plug_id=>362379936923619989+wwv_flow_api.g_id_offset
,p_button_name=>'WEEKLY'
,p_button_action=>'REDIRECT_URL'
...
,p_button_position=>'TOP'
,p_button_redirect_url=>'javascript:apex.widget.calendar.ajax_calendar(''W'',''same''); void(0);'
,p_button_condition=>'P25_CALENDAR_TYPE'
,p_button_condition2=>'W'
,p_button_condition_type=>'NEVER'
,p_button_comment=>'Generated 04/17/2014'
);
wwv_flow_api.create_page_button(
 p_id=>362381891158619997+wwv_flow_api.g_id_offset
,p_button_sequence=>30
,p_button_plug_id=>362379936923619989+wwv_flow_api.g_id_offset
,p_button_name=>'DAILY'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_button(
 p_id=>362382018250619997+wwv_flow_api.g_id_offset
,p_button_sequence=>40
,p_button_plug_id=>362379936923619989+wwv_flow_api.g_id_offset
,p_button_name=>'LISTVIEW'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_button(
 p_id=>362382288711619997+wwv_flow_api.g_id_offset
,p_button_sequence=>50
,p_button_plug_id=>362379936923619989+wwv_flow_api.g_id_offset
,p_button_name=>'PREVIOUS'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_button(
 p_id=>362382430760619997+wwv_flow_api.g_id_offset
,p_button_sequence=>60
,p_button_plug_id=>362379936923619989+wwv_flow_api.g_id_offset
,p_button_name=>'TODAY'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_button(
 p_id=>362382635607619998+wwv_flow_api.g_id_offset
,p_button_sequence=>70
,p_button_plug_id=>362379936923619989+wwv_flow_api.g_id_offset
,p_button_name=>'NEXT'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_item(
 p_id=>362380954418619995+wwv_flow_api.g_id_offset
,p_name=>'P25_CALENDAR_TYPE'
,p_item_sequence=>10
,p_item_plug_id=>362379936923619989+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
,p_prompt=>'P25_CALENDAR_DISPLAY'
,p_source=>'P25_CALENDAR_TYPE'
,p_source_type=>'ITEM'
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
,p_item_comment=>'Generated by Calendar wizard on 04/17/2014'
...
wwv_flow_api.create_page_item(
 p_id=>362381101952619995+wwv_flow_api.g_id_offset
,p_name=>'P25_CALENDAR_DATE'
,p_item_sequence=>20
,p_item_plug_id=>362379936923619989+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
,p_item_default=>'return sysdate;'
...
wwv_flow_api.create_page_item(
 p_id=>362381334801619996+wwv_flow_api.g_id_offset
,p_name=>'P25_CALENDAR_END_DATE'
,p_item_sequence=>30
,p_item_plug_id=>362379936923619989+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
,p_item_default=>'return sysdate+3;'
,p_item_default_type=>'PLSQL_FUNCTION_BODY'
,p_prompt=>'End Date'
,p_source=>'P25_CALENDAR_END_DATE'
,p_source_type=>'ITEM'
,p_display_as=>'NATIVE_HIDDEN'
,p_begin_on_new_line=>'N'
,p_attribute_01=>'N'
