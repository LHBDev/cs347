...
--   Date and Time:   06:43 Saturday April 19, 2014
...
,p_last_upd_yyyymmddhh24miss=>'20140419064216'
,p_ui_type_name => null
);
end;
/
...
wwv_flow_api.create_list(
 p_id=>377845051669104732+wwv_flow_api.g_id_offset
,p_name=>'SERVICE_TYPE'
,p_list_type=>'SQL_QUERY'
,p_list_query=>'select name, type_id from BC_service_type'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list(
 p_id=>377870784803114403+wwv_flow_api.g_id_offset
,p_name=>'SERVICE_TYPE'
,p_list_type=>'SQL_QUERY'
,p_list_query=>'select name, type_id from BC_service_type'
,p_list_status=>'PUBLIC'
...
wwv_flow_api.create_list(
 p_id=>378251403602288890+wwv_flow_api.g_id_offset
,p_name=>'SERVICE_TYPE'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>378251698997288890+wwv_flow_api.g_id_offset
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'RECEIVE'
,p_list_item_link_target=>'f?p=&APP_ID.::&SESSION.:'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
 p_id=>378251995808288893+wwv_flow_api.g_id_offset
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'PROVIDE'
,p_list_item_link_target=>'f?p=&APP_ID.::&SESSION.:'
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
 p_id=>378252225579288894+wwv_flow_api.g_id_offset
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'REC & PROV'
,p_list_item_link_target=>'f?p=&APP_ID.::&SESSION.:'
,p_list_item_current_type=>'TARGET_PAGE'
);
end;
...
wwv_flow_api.create_tab(
 p_id=>379355595921570334+wwv_flow_api.g_id_offset
,p_tab_set=>'TS1'
,p_tab_sequence=>70
,p_tab_name=>'Notes'
,p_tab_text=>'Notes'
...
,p_last_updated_by=>'GREGSTONT@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20140419063342'
);
...
,p_plug_name=>'Upcoming Expirations'
...
,p_cal_id=>362414445985680831+wwv_flow_api.g_id_offset
...
,p_custom_cal_days=>3
,p_primary_key_column=>'CONTRACT_ID'
,p_item_link_primary_key_item=>'P6_CONTRACT'
,p_item_link_date_item=>'P6_ending_date'
,p_item_link_open_in=>'W'
,p_include_time_with_date=>'N'
,p_agenda_cal_days_type=>'MONTH'
,p_agenda_cal_days=>30
,p_calendar_type=>'A'
,p_template_id=>350502938107139742+wwv_flow_api.g_id_offset
);
wwv_flow_api.create_page_button(
 p_id=>362415256057680833+wwv_flow_api.g_id_offset
,p_button_sequence=>10
,p_button_plug_id=>362414239153680830+wwv_flow_api.g_id_offset
...
,p_button_condition=>'NVL(:P1_CALENDAR_TYPE, ''M'') <> ''M'''
,p_button_comment=>'Generated 04/17/2014'
);
wwv_flow_api.create_page_button(
 p_id=>362415423370680834+wwv_flow_api.g_id_offset
...
,p_button_condition=>'P1_CALENDAR_TYPE'
,p_button_condition2=>'W'
,p_button_condition_type=>'NEVER'
,p_button_comment=>'Generated 04/17/2014'
);
wwv_flow_api.create_page_button(
 p_id=>362415636151680834+wwv_flow_api.g_id_offset
...
wwv_flow_api.create_page_button(
 p_id=>362415840876680834+wwv_flow_api.g_id_offset
...
wwv_flow_api.create_page_button(
 p_id=>362416055375680835+wwv_flow_api.g_id_offset
...
wwv_flow_api.create_page_button(
 p_id=>362416210979680835+wwv_flow_api.g_id_offset
...
wwv_flow_api.create_page_button(
 p_id=>362416446313680835+wwv_flow_api.g_id_offset
...
wwv_flow_api.create_page_item(
 p_id=>362414719472680832+wwv_flow_api.g_id_offset
,p_name=>'P1_CALENDAR_TYPE'
,p_item_sequence=>10
,p_item_plug_id=>362414239153680830+wwv_flow_api.g_id_offset
...
,p_attribute_01=>'N'
,p_item_comment=>'Generated by Calendar wizard on 04/17/2014'
);
wwv_flow_api.create_page_item(
 p_id=>362414999169680833+wwv_flow_api.g_id_offset
...
wwv_flow_api.create_page_item(
 p_id=>362415121593680833+wwv_flow_api.g_id_offset
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'GREGSTONT@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20140419063808'
);
wwv_flow_api.create_page_plug(
...
,p_detail_link=>'f?p=&APP_ID.:6:&SESSION.::&DEBUG.::P6_CONTRACT,P6_HIDEAMEND,P6_CONTRACT_ID1:#CONTRACT_ID#,#CONTRACT_ID1#,#CONTRACT_ID1#'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'GREGSTONT@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20140419055733'
);
wwv_flow_api.create_page_plug(
...
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>'select name as name1, name as name2 from bc_status'
,p_cSize=>32
,p_cMaxlength=>255
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
...
wwv_flow_api.create_page_item(
 p_id=>378044004691211579+wwv_flow_api.g_id_offset
,p_name=>'P3_CONTRACT'
,p_item_sequence=>450
,p_item_plug_id=>350538023233165381+wwv_flow_api.g_id_offset
...
wwv_flow_api.create_page_item(
 p_id=>381399262089621587+wwv_flow_api.g_id_offset
,p_name=>'P3_PRIMARY_CONTACT'
,p_item_sequence=>460
,p_item_plug_id=>350538023233165381+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>'select name as name1, name as name2 from creo_contact'
...
wwv_flow_api.create_report_columns(
 p_id=>381398708904594257+wwv_flow_api.g_id_offset
,p_query_column_id=>45
,p_column_alias=>'PRIMARY_CONTACT'
,p_column_display_sequence=>45
,p_column_heading=>'Primary Contact'
,p_use_as_row_header=>'N'
,p_column_link=>'f?p=&APP_ID.:38:&SESSION.::&DEBUG.::P38_NAME:#PRIMARY_CONTACT#'
,p_column_linktext=>'#PRIMARY_CONTACT#'
,p_lov_show_nulls=>'NO'
,p_lov_display_extra=>'YES'
,p_include_in_export=>'Y'
);
...
,p_include_in_reg_disp_sel_yn=>'N'
,p_display_point=>'BODY'
,p_source=>'select * from BC_contract where CONTRACT_ID1 = :P6_CONTRACT_ID1 order by contract_id'
,p_source_type=>'NATIVE_SQL_REPORT'
,p_ajax_enabled=>'Y'
...
,p_column_heading=>'CONTRACT_ID'
,p_use_as_row_header=>'N'
,p_column_link=>'f?p=&APP_ID.:6:&SESSION.::&DEBUG.::P6_CONTRACT:#CONTRACT_ID#'
,p_column_linktext=>'#CONTRACT_ID#'
,p_heading_alignment=>'LEFT'
,p_lov_show_nulls=>'NO'
,p_lov_display_extra=>'YES'
,p_include_in_export=>'Y'
...
wwv_flow_api.create_report_columns(
 p_id=>369064538933327493+wwv_flow_api.g_id_offset
,p_query_column_id=>2
,p_column_alias=>'RECEIVED_DATE'
,p_column_display_sequence=>3
...
wwv_flow_api.create_report_columns(
 p_id=>369064649178327493+wwv_flow_api.g_id_offset
,p_query_column_id=>3
,p_column_alias=>'INITIALS'
,p_column_display_sequence=>7
,p_column_heading=>'Initials'
...
wwv_flow_api.create_report_columns(
 p_id=>369064727695327493+wwv_flow_api.g_id_offset
,p_query_column_id=>4
,p_column_alias=>'PURPOSE'
,p_column_display_sequence=>6
,p_column_heading=>'Purpose'
...
wwv_flow_api.create_report_columns(
 p_id=>369064874669327493+wwv_flow_api.g_id_offset
,p_query_column_id=>5
,p_column_alias=>'NOTES'
,p_column_display_sequence=>9
,p_column_heading=>'Notes'
...
wwv_flow_api.create_report_columns(
 p_id=>369064993653327493+wwv_flow_api.g_id_offset
,p_query_column_id=>6
,p_column_alias=>'BEGINNING_DATE'
,p_column_display_sequence=>8
,p_column_heading=>'Beginning Date'
);
wwv_flow_api.create_report_columns(
 p_id=>369065018998327493+wwv_flow_api.g_id_offset
,p_query_column_id=>7
,p_column_alias=>'ENDING_DATE'
,p_column_display_sequence=>10
,p_column_heading=>'Ending Date'
);
wwv_flow_api.create_report_columns(
 p_id=>369065199383327493+wwv_flow_api.g_id_offset
,p_query_column_id=>8
,p_column_alias=>'REMAINING_RENEWAL'
,p_column_display_sequence=>11
,p_column_heading=>'Remaining Renewal'
,p_hidden_column=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>369065260082327493+wwv_flow_api.g_id_offset
,p_query_column_id=>9
,p_column_alias=>'REMAINING_LENGTHS'
,p_column_display_sequence=>12
,p_column_heading=>'Remaining Lengths'
,p_hidden_column=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>369065382739327493+wwv_flow_api.g_id_offset
,p_query_column_id=>10
,p_column_alias=>'FOREIGN_CONTRACT'
,p_column_display_sequence=>13
,p_column_heading=>'Foreign Contract'
,p_hidden_column=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>369065424921327493+wwv_flow_api.g_id_offset
,p_query_column_id=>11
,p_column_alias=>'FACILITY_USE_REPORTS'
,p_column_display_sequence=>14
,p_column_heading=>'Facility Use Reports'
,p_hidden_column=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>369065595147327493+wwv_flow_api.g_id_offset
,p_query_column_id=>12
,p_column_alias=>'SERVICE_TYPE'
,p_column_display_sequence=>5
...
wwv_flow_api.create_report_columns(
 p_id=>369065625184327493+wwv_flow_api.g_id_offset
,p_query_column_id=>13
,p_column_alias=>'ACCOUNT_TYPE'
,p_column_display_sequence=>4
...
wwv_flow_api.create_report_columns(
 p_id=>369065725014327493+wwv_flow_api.g_id_offset
,p_query_column_id=>14
,p_column_alias=>'CONTRACT_AMOUNT'
,p_column_display_sequence=>15
,p_column_heading=>'Contract Amount'
);
wwv_flow_api.create_report_columns(
 p_id=>369065811999327493+wwv_flow_api.g_id_offset
,p_query_column_id=>15
,p_column_alias=>'DATE_RETURNED'
,p_column_display_sequence=>16
,p_column_heading=>'Date Returned'
,p_hidden_column=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>369065963972327493+wwv_flow_api.g_id_offset
,p_query_column_id=>16
,p_column_alias=>'LAST_CONTACT_DATE'
,p_column_display_sequence=>17
,p_column_heading=>'Last Contact Date'
,p_hidden_column=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>369066092912327493+wwv_flow_api.g_id_offset
,p_query_column_id=>17
,p_column_alias=>'STATUS'
,p_column_display_sequence=>2
,p_column_heading=>'Status'
...
wwv_flow_api.create_report_columns(
 p_id=>369066110994327493+wwv_flow_api.g_id_offset
,p_query_column_id=>18
,p_column_alias=>'SIGNED_BY'
,p_column_display_sequence=>18
,p_column_heading=>'Signed By'
,p_hidden_column=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>369066273162327494+wwv_flow_api.g_id_offset
,p_query_column_id=>19
,p_column_alias=>'REVIEWED_BY'
,p_column_display_sequence=>19
...
wwv_flow_api.create_report_columns(
 p_id=>369066380932327494+wwv_flow_api.g_id_offset
,p_query_column_id=>20
,p_column_alias=>'SIGNED_DATE'
,p_column_display_sequence=>20
...
wwv_flow_api.create_report_columns(
 p_id=>369066497207327494+wwv_flow_api.g_id_offset
,p_query_column_id=>21
,p_column_alias=>'OGC'
,p_column_display_sequence=>21
,p_column_heading=>'Ogc'
...
wwv_flow_api.create_report_columns(
 p_id=>369066568027327494+wwv_flow_api.g_id_offset
,p_query_column_id=>22
,p_column_alias=>'EVC'
,p_column_display_sequence=>22
,p_column_heading=>'Evc'
...
wwv_flow_api.create_report_columns(
 p_id=>369066604980327494+wwv_flow_api.g_id_offset
,p_query_column_id=>23
,p_column_alias=>'BOR'
,p_column_display_sequence=>23
,p_column_heading=>'Bor'
...
wwv_flow_api.create_report_columns(
 p_id=>369066719245327494+wwv_flow_api.g_id_offset
,p_query_column_id=>24
,p_column_alias=>'DOCKET'
,p_column_display_sequence=>24
,p_column_heading=>'Docket'
...
wwv_flow_api.create_report_columns(
 p_id=>369066840685327494+wwv_flow_api.g_id_offset
,p_query_column_id=>25
,p_column_alias=>'DOCKET_DATE'
,p_column_display_sequence=>25
,p_column_heading=>'Docket Date'
,p_hidden_column=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>369066947532327494+wwv_flow_api.g_id_offset
,p_query_column_id=>26
,p_column_alias=>'SYSTEM_NOTES'
,p_column_display_sequence=>26
,p_column_heading=>'System Notes'
,p_hidden_column=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>369067007045327494+wwv_flow_api.g_id_offset
,p_query_column_id=>27
,p_column_alias=>'AMENDMENT_VERSION'
,p_column_display_sequence=>27
,p_column_heading=>'Amendment Version'
,p_hidden_column=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>369067147941327494+wwv_flow_api.g_id_offset
,p_query_column_id=>28
,p_column_alias=>'AMENDMENT_TOTAL'
,p_column_display_sequence=>28
,p_column_heading=>'Amendment Total'
,p_hidden_column=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>369067235359327494+wwv_flow_api.g_id_offset
,p_query_column_id=>29
,p_column_alias=>'VENDOR_ID'
,p_column_display_sequence=>29
...
wwv_flow_api.create_report_columns(
 p_id=>369067347709327494+wwv_flow_api.g_id_offset
,p_query_column_id=>30
,p_column_alias=>'DEPT_ID'
,p_column_display_sequence=>30
...
wwv_flow_api.create_report_columns(
 p_id=>369067468589327494+wwv_flow_api.g_id_offset
,p_query_column_id=>31
,p_column_alias=>'CONTRACT_ID1'
,p_column_display_sequence=>31
,p_column_heading=>'Contract Id1'
,p_hidden_column=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>369067503479327494+wwv_flow_api.g_id_offset
,p_query_column_id=>32
,p_column_alias=>'DEPT_ID1'
,p_column_display_sequence=>32
,p_column_heading=>'Dept Id1'
,p_hidden_column=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>369067672381327494+wwv_flow_api.g_id_offset
,p_query_column_id=>33
,p_column_alias=>'VENDOR_ID1'
,p_column_display_sequence=>33
,p_column_heading=>'Vendor Id1'
,p_hidden_column=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>369067703410327494+wwv_flow_api.g_id_offset
,p_query_column_id=>34
,p_column_alias=>'DFLEX'
,p_column_display_sequence=>34
,p_column_heading=>'Dflex'
...
wwv_flow_api.create_report_columns(
 p_id=>369067849437327494+wwv_flow_api.g_id_offset
,p_query_column_id=>35
,p_column_alias=>'IFLEX1'
,p_column_display_sequence=>35
,p_column_heading=>'Iflex1'
...
wwv_flow_api.create_report_columns(
 p_id=>369067996179327495+wwv_flow_api.g_id_offset
,p_query_column_id=>36
,p_column_alias=>'IFLEX2'
,p_column_display_sequence=>36
,p_column_heading=>'Iflex2'
...
wwv_flow_api.create_report_columns(
 p_id=>369068045515327495+wwv_flow_api.g_id_offset
,p_query_column_id=>37
,p_column_alias=>'VFLEX1'
,p_column_display_sequence=>37
,p_column_heading=>'Vflex1'
...
wwv_flow_api.create_report_columns(
 p_id=>369068147900327495+wwv_flow_api.g_id_offset
,p_query_column_id=>38
,p_column_alias=>'VFLEX2'
,p_column_display_sequence=>38
,p_column_heading=>'Vflex2'
...
wwv_flow_api.create_report_columns(
 p_id=>369068202918327495+wwv_flow_api.g_id_offset
,p_query_column_id=>39
,p_column_alias=>'VFLEX3'
,p_column_display_sequence=>39
,p_column_heading=>'Vflex3'
...
begin
wwv_flow_api.create_report_columns(
 p_id=>369068319193327495+wwv_flow_api.g_id_offset
,p_query_column_id=>40
,p_column_alias=>'CREATED'
,p_column_display_sequence=>40
,p_column_heading=>'Created'
...
wwv_flow_api.create_report_columns(
 p_id=>369068430270327495+wwv_flow_api.g_id_offset
,p_query_column_id=>41
,p_column_alias=>'CREATED_BY'
,p_column_display_sequence=>41
...
wwv_flow_api.create_report_columns(
 p_id=>369068570035327495+wwv_flow_api.g_id_offset
,p_query_column_id=>42
,p_column_alias=>'ROW_VERSION_NUMBER'
,p_column_display_sequence=>42
...
wwv_flow_api.create_report_columns(
 p_id=>369068634488327495+wwv_flow_api.g_id_offset
,p_query_column_id=>43
,p_column_alias=>'UPDATED'
,p_column_display_sequence=>43
,p_column_heading=>'Updated'
...
wwv_flow_api.create_report_columns(
 p_id=>369068711634327495+wwv_flow_api.g_id_offset
,p_query_column_id=>44
,p_column_alias=>'UPDATED_BY'
,p_column_display_sequence=>44
...
wwv_flow_api.create_report_columns(
 p_id=>381429404570913317+wwv_flow_api.g_id_offset
,p_query_column_id=>45
,p_column_alias=>'PRIMARY_CONTACT'
,p_column_display_sequence=>45
,p_column_heading=>'Primary Contact'
...
wwv_flow_api.create_report_columns(
 p_id=>381429562004913318+wwv_flow_api.g_id_offset
...
wwv_flow_api.create_report_columns(
 p_id=>379708837434708998+wwv_flow_api.g_id_offset
,p_query_column_id=>16
,p_column_alias=>'NOTE_DATE'
,p_column_display_sequence=>1
,p_column_heading=>'Note Date'
);
wwv_flow_api.create_page_button(
...
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_button_redirect_url=>'f?p=&APP_ID.:36:&SESSION.::&DEBUG.::P36_CONTRACT_ID:&P6_CONTRACT.'
);
wwv_flow_api.create_page_button(
 p_id=>367557416319768272+wwv_flow_api.g_id_offset
,p_button_sequence=>40
,p_button_plug_id=>350811336162255064+wwv_flow_api.g_id_offset
,p_button_name=>'CHECKLIST'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_id=>350502025920139741+wwv_flow_api.g_id_offset
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Checklist'
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_button_redirect_url=>'f?p=&APP_ID.:30:&SESSION.::&DEBUG.::P30_check:&P6_CONTRACT.'
);
wwv_flow_api.create_page_button(
 p_id=>378042719614172935+wwv_flow_api.g_id_offset
,p_button_sequence=>50
,p_button_plug_id=>350811336162255064+wwv_flow_api.g_id_offset
,p_button_name=>'EDIT'
,p_button_action=>'REDIRECT_PAGE'
...
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_button_redirect_url=>'f?p=&APP_ID.:3:&SESSION.::&DEBUG.::P3_CONTRACT:&P6_CONTRACT.'
);
wwv_flow_api.create_page_item(
...
wwv_flow_api.create_page_item(
 p_id=>364640267312976892+wwv_flow_api.g_id_offset
,p_name=>'P6_CONTRACT_ID1'
,p_item_sequence=>40
,p_item_plug_id=>350811336162255064+wwv_flow_api.g_id_offset
,p_source_type=>'ALWAYS_NULL'
,p_display_as=>'NATIVE_HIDDEN'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'GREGSTONT@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20140418225141'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page_da_event(
 p_id=>368119124351174571+wwv_flow_api.g_id_offset
,p_name=>'doc refresh'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>351987078905785231+wwv_flow_api.g_id_offset
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>368119470517174572+wwv_flow_api.g_id_offset
,p_event_id=>368119124351174571+wwv_flow_api.g_id_offset
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'GREGSTONT@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20140418213540'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page_item(
 p_id=>379458399923624618+wwv_flow_api.g_id_offset
,p_name=>'P13_NOTE_DATE'
,p_item_sequence=>90
,p_item_plug_id=>357996136100672209+wwv_flow_api.g_id_offset
,p_prompt=>'Note Date'
,p_source=>'note_date'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'GREGSTONT@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20140419055859'
);
wwv_flow_api.create_page_plug(
...
,p_show_calendar=>'N'
,p_download_formats=>'CSV:HTML:EMAIL:XLS:PDF:RTF'
,p_detail_link=>'f?p=&APP_ID.:16:&SESSION.::&DEBUG.::P16_DEPT_ID:#DEPT_ID#'
,p_detail_link_text=>'<img src="#IMAGE_PREFIX#e2.gif"  border="0">'
,p_allow_exclude_null_values=>'N'
,p_allow_hide_extra_columns=>'N'
,p_icon_view_columns_per_row=>1
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'GREGSTONT@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20140419050406'
);
wwv_flow_api.create_page_plug(
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'GREGSTONT@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20140419062215'
);
wwv_flow_api.create_page_plug(
...
,p_show_calendar=>'N'
,p_download_formats=>'CSV:HTML:EMAIL:XLS:PDF:RTF'
,p_detail_link=>'f?p=&APP_ID.:22:&SESSION.::&DEBUG.::P22_CONTACT_ID:#CONTACT_ID#'
,p_detail_link_text=>'<img src="#IMAGE_PREFIX#e2.gif"  border="0">'
,p_allow_exclude_null_values=>'N'
,p_allow_hide_extra_columns=>'N'
,p_icon_view_columns_per_row=>1
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'GREGSTONT@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20140419063029'
);
wwv_flow_api.create_page_plug(
...
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_POPUP_LOV'
,p_lov=>'select name as name1, name as name2 from bc_state'
,p_cSize=>32
,p_cMaxlength=>50
,p_cHeight=>1
,p_label_alignment=>'RIGHT'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'GREGSTONT@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20140419060910'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_worksheet_column(
 p_id=>381413799865685739+wwv_flow_api.g_id_offset
,p_db_column_name=>'PRIMARY_CONTACT'
,p_display_order=>8
,p_column_identifier=>'H'
,p_column_label=>'Primary Contact'
...
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'VENDOR_ID:V_ADDRESS:V_CITY:V_STATE:V_ZIP:V_COUNTRY:VENDOR_NAME:PRIMARY_CONTACT'
,p_flashback_enabled=>'N'
);
wwv_flow_api.create_page_button(
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'GREGSTONT@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20140419060733'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page_item(
 p_id=>381414126928699495+wwv_flow_api.g_id_offset
,p_name=>'P24_PRIMARY_CONTACT'
,p_item_sequence=>70
,p_item_plug_id=>361496165064137229+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
,p_prompt=>'Primary Contact'
...
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_step_template=>350492919149139725+wwv_flow_api.g_id_offset
,p_overwrite_navigation_list=>'N'
,p_page_is_public_y_n=>'N'
,p_cache_timeout_seconds=>21600
,p_cache_by_user_yn=>'N'
...
wwv_flow_api.create_report_region(
 p_id=>367547174574749468+wwv_flow_api.g_id_offset
,p_name=>'VP/CFO Business Contract Procedure Checklist'
,p_template=>350494621658139731+wwv_flow_api.g_id_offset
,p_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
,p_display_point=>'BODY'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select ',
'd.dept_name, v.vendor_name, c.contract_amount, c.vendor_id, c.received_date, c.beginning_date, c.ending_date ',
'from ',
'BC_dept d, BC_vendor v, BC_contract c ',
'where ',
'd.dept_id = c.dept_id ',
'and v.vendor_id = c.vendor_id ',
'and c.contract_id = :P30_check'))
,p_source_type=>'NATIVE_SQL_REPORT'
,p_translate_title=>'N'
,p_ajax_enabled=>'Y'
,p_query_row_template=>350499050003139736+wwv_flow_api.g_id_offset
...
wwv_flow_api.create_report_columns(
 p_id=>380230341946137608+wwv_flow_api.g_id_offset
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>380232930145165416+wwv_flow_api.g_id_offset
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>380233089654165416+wwv_flow_api.g_id_offset
,p_query_column_id=>3
,p_column_alias=>'CONTRACT_AMOUNT'
,p_column_display_sequence=>3
,p_column_heading=>'Contract Amount'
...
wwv_flow_api.create_report_columns(
 p_id=>380418083848210799+wwv_flow_api.g_id_offset
,p_query_column_id=>4
,p_column_alias=>'VENDOR_ID'
,p_column_display_sequence=>7
,p_column_heading=>'Vendor Id'
...
wwv_flow_api.create_report_columns(
 p_id=>380233245284165416+wwv_flow_api.g_id_offset
,p_query_column_id=>5
,p_column_alias=>'RECEIVED_DATE'
,p_column_display_sequence=>4
,p_column_heading=>'Received Date'
...
wwv_flow_api.create_report_columns(
 p_id=>380233382408165416+wwv_flow_api.g_id_offset
,p_query_column_id=>6
,p_column_alias=>'BEGINNING_DATE'
,p_column_display_sequence=>5
,p_column_heading=>'Beginning Date'
...
wwv_flow_api.create_report_columns(
 p_id=>380233483244165416+wwv_flow_api.g_id_offset
,p_query_column_id=>7
,p_column_alias=>'ENDING_DATE'
,p_column_display_sequence=>6
,p_column_heading=>'Ending Date'
...
wwv_flow_api.create_page_plug(
 p_id=>367634815471906774+wwv_flow_api.g_id_offset
,p_plug_name=>'image'
,p_parent_plug_id=>367547174574749468+wwv_flow_api.g_id_offset
,p_plug_template=>350494745894139731+wwv_flow_api.g_id_offset
,p_plug_display_sequence=>20
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_new_grid_row=>false
,p_plug_new_grid_column=>false
,p_plug_display_point=>'BODY'
,p_plug_source=>'<img src="http://i.imgur.com/VyAxgqG.png">'
,p_plug_query_row_template=>1
,p_plug_query_headings_type=>'QUERY_COLUMNS'
,p_plug_query_num_rows_type=>'NEXT_PREVIOUS_LINKS'
,p_plug_query_show_nulls_as=>' - '
...
wwv_flow_api.create_page_item(
 p_id=>367555136808754172+wwv_flow_api.g_id_offset
,p_name=>'P30_CHECK'
,p_item_sequence=>10
,p_item_plug_id=>367547174574749468+wwv_flow_api.g_id_offset
,p_source_type=>'ALWAYS_NULL'
,p_display_as=>'NATIVE_HIDDEN'
,p_cMaxlength=>4000
,p_label_alignment=>'RIGHT'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'GREGSTONT@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20140418215424'
);
wwv_flow_api.create_page_plug(
 p_id=>378799335506519691+wwv_flow_api.g_id_offset
,p_plug_name=>'Note'
,p_plug_template=>350495633504139732+wwv_flow_api.g_id_offset
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
...
wwv_flow_api.create_page_button(
 p_id=>378799634755519692+wwv_flow_api.g_id_offset
,p_button_sequence=>30
,p_button_plug_id=>378799335506519691+wwv_flow_api.g_id_offset
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_id=>350501692613139741+wwv_flow_api.g_id_offset
,p_button_image_alt=>'Apply Changes'
,p_button_position=>'REGION_TEMPLATE_CHANGE'
,p_button_condition=>'P31_NOTE_ID'
,p_button_condition_type=>'ITEM_IS_NOT_NULL'
,p_database_action=>'UPDATE'
);
wwv_flow_api.create_page_button(
 p_id=>378799819370519692+wwv_flow_api.g_id_offset
,p_button_sequence=>10
,p_button_plug_id=>378799335506519691+wwv_flow_api.g_id_offset
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_api.create_page_button(
 p_id=>378799558015519692+wwv_flow_api.g_id_offset
,p_button_sequence=>40
,p_button_plug_id=>378799335506519691+wwv_flow_api.g_id_offset
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>378799771076519692+wwv_flow_api.g_id_offset
,p_button_sequence=>20
,p_button_plug_id=>378799335506519691+wwv_flow_api.g_id_offset
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_branch(
 p_id=>378800906318519694+wwv_flow_api.g_id_offset
...
wwv_flow_api.create_page_item(
 p_id=>378801170004519695+wwv_flow_api.g_id_offset
,p_name=>'P31_NOTE_ID'
,p_item_sequence=>10
,p_item_plug_id=>378799335506519691+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
,p_prompt=>'Note Id'
,p_source=>'NOTE_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>378801331136519696+wwv_flow_api.g_id_offset
,p_name=>'P31_DATE'
,p_item_sequence=>20
,p_item_plug_id=>378799335506519691+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>378801574199519697+wwv_flow_api.g_id_offset
,p_name=>'P31_TEXT'
,p_item_sequence=>30
,p_item_plug_id=>378799335506519691+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>378801762187519697+wwv_flow_api.g_id_offset
...
wwv_flow_api.create_page_item(
 p_id=>378801976782519698+wwv_flow_api.g_id_offset
,p_name=>'P31_CREATED'
,p_item_sequence=>50
,p_item_plug_id=>378799335506519691+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>378802138424519698+wwv_flow_api.g_id_offset
...
wwv_flow_api.create_page_item(
 p_id=>378802322588519698+wwv_flow_api.g_id_offset
,p_name=>'P31_UPDATED'
,p_item_sequence=>70
,p_item_plug_id=>378799335506519691+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>378802506019519698+wwv_flow_api.g_id_offset
...
wwv_flow_api.create_page_da_event(
 p_id=>378799931248519692+wwv_flow_api.g_id_offset
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>378799819370519692+wwv_flow_api.g_id_offset
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>378800354590519693+wwv_flow_api.g_id_offset
,p_event_id=>378799931248519692+wwv_flow_api.g_id_offset
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>378803339966519699+wwv_flow_api.g_id_offset
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from BC_NOTE'
,p_attribute_02=>'BC_NOTE'
,p_attribute_03=>'P31_NOTE_ID'
,p_attribute_04=>'NOTE_ID'
,p_attribute_11=>'I:U:D'
);
wwv_flow_api.create_page_process(
 p_id=>378803566874519700+wwv_flow_api.g_id_offset
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of BC_NOTE'
...
wwv_flow_api.create_page_process(
 p_id=>378803760112519700+wwv_flow_api.g_id_offset
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>378799771076519692+wwv_flow_api.g_id_offset
);
wwv_flow_api.create_page_process(
 p_id=>378803955122519700+wwv_flow_api.g_id_offset
,p_process_sequence=>50
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'GREGSTONT@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20140419045752'
);
wwv_flow_api.create_calendar(
 p_id=>379355037202570332+wwv_flow_api.g_id_offset
,p_plug_name=>'Notes'
,p_plug_source=>'select note_id, text, ''Notice for contract '' || contract_id as display, note_date from bc_note'
,p_plug_source_type=>'NATIVE_CALENDAR'
,p_plug_template=>350494547112139731+wwv_flow_api.g_id_offset
,p_plug_display_sequence=>10
,p_plug_display_point=>'BODY'
,p_plug_item_display_point=>'ABOVE'
,p_cal_id=>379355725209570335+wwv_flow_api.g_id_offset
,p_begin_at_start_of_interval=>'Y'
,p_date_item=>'P33_CALENDAR_DATE'
,p_display_as=>'M'
,p_display_item=>'P33_CALENDAR_DISPLAY'
,p_display_type=>'COL'
,p_date_column=>'NOTE_DATE'
,p_display_column=>'TEXT'
,p_start_of_week=>19721105
,p_item_link=>'f?p=&FLOW_ID.:37:&SESSION.::&DEBUG.:37:P37_NOTE_ID,P37_NOTE_IDD:#PRIMARY_KEY_VALUE#,#DATE_VALUE#'
,p_start_time=>0
,p_end_time=>23
,p_time_format=>'24HOUR'
,p_week_start_day=>19721105
,p_week_end_day=>19721111
,p_date_type_column=>'P33_CALENDAR_TYPE'
,p_end_date_item=>'P33_CALENDAR_END_DATE'
,p_include_custom_cal=>'N'
,p_custom_cal_days=>3
,p_primary_key_column=>'NOTE_ID'
,p_item_link_primary_key_item=>'P31_NOTE_ID'
,p_item_link_date_item=>'P31_NOTE_IDD'
,p_item_link_open_in=>'W'
,p_include_time_with_date=>'N'
,p_agenda_cal_days_type=>'MONTH'
,p_agenda_cal_days=>30
...
wwv_flow_api.create_page_button(
 p_id=>379356566740570336+wwv_flow_api.g_id_offset
,p_button_sequence=>10
,p_button_plug_id=>379355037202570332+wwv_flow_api.g_id_offset
,p_button_name=>'MONTHLY'
,p_button_action=>'REDIRECT_URL'
,p_button_template_id=>350501692613139741+wwv_flow_api.g_id_offset
,p_button_image_alt=>'Monthly'
,p_button_position=>'TOP'
,p_button_redirect_url=>'javascript:apex.widget.calendar.ajax_calendar(''M'',''same''); void(0);'
,p_button_condition=>'NVL(:P33_CALENDAR_TYPE, ''M'') <> ''M'''
,p_button_comment=>'Generated 04/18/2014'
);
wwv_flow_api.create_page_button(
 p_id=>379356766159570337+wwv_flow_api.g_id_offset
,p_button_sequence=>20
,p_button_plug_id=>379355037202570332+wwv_flow_api.g_id_offset
,p_button_name=>'WEEKLY'
,p_button_action=>'REDIRECT_URL'
...
,p_button_position=>'TOP'
,p_button_redirect_url=>'javascript:apex.widget.calendar.ajax_calendar(''W'',''same''); void(0);'
,p_button_condition=>'P33_CALENDAR_TYPE'
,p_button_condition2=>'W'
,p_button_condition_type=>'NEVER'
,p_button_comment=>'Generated 04/18/2014'
);
wwv_flow_api.create_page_button(
 p_id=>379356930539570337+wwv_flow_api.g_id_offset
,p_button_sequence=>30
,p_button_plug_id=>379355037202570332+wwv_flow_api.g_id_offset
,p_button_name=>'DAILY'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_button(
 p_id=>379357141695570337+wwv_flow_api.g_id_offset
,p_button_sequence=>40
,p_button_plug_id=>379355037202570332+wwv_flow_api.g_id_offset
,p_button_name=>'LISTVIEW'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_button(
 p_id=>379357387089570338+wwv_flow_api.g_id_offset
,p_button_sequence=>50
,p_button_plug_id=>379355037202570332+wwv_flow_api.g_id_offset
,p_button_name=>'PREVIOUS'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_button(
 p_id=>379357541679570338+wwv_flow_api.g_id_offset
,p_button_sequence=>60
,p_button_plug_id=>379355037202570332+wwv_flow_api.g_id_offset
,p_button_name=>'TODAY'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_button(
 p_id=>379357717958570338+wwv_flow_api.g_id_offset
,p_button_sequence=>70
,p_button_plug_id=>379355037202570332+wwv_flow_api.g_id_offset
,p_button_name=>'NEXT'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_item(
 p_id=>379356071328570336+wwv_flow_api.g_id_offset
,p_name=>'P33_CALENDAR_TYPE'
,p_item_sequence=>10
,p_item_plug_id=>379355037202570332+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
,p_prompt=>'P33_CALENDAR_DISPLAY'
,p_source=>'P33_CALENDAR_TYPE'
,p_source_type=>'ITEM'
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
,p_item_comment=>'Generated by Calendar wizard on 04/18/2014'
);
wwv_flow_api.create_page_item(
 p_id=>379356206785570336+wwv_flow_api.g_id_offset
,p_name=>'P33_CALENDAR_DATE'
,p_item_sequence=>20
,p_item_plug_id=>379355037202570332+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
,p_item_default=>'return sysdate;'
...
wwv_flow_api.create_page_item(
 p_id=>379356429181570336+wwv_flow_api.g_id_offset
,p_name=>'P33_CALENDAR_END_DATE'
,p_item_sequence=>30
,p_item_plug_id=>379355037202570332+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
,p_item_default=>'return sysdate+3;'
,p_item_default_type=>'PLSQL_FUNCTION_BODY'
,p_prompt=>'End Date'
,p_source=>'P33_CALENDAR_END_DATE'
,p_source_type=>'ITEM'
,p_display_as=>'NATIVE_HIDDEN'
,p_begin_on_new_line=>'N'
,p_attribute_01=>'N'
...
,p_user_interface_id=>350503419048139745+wwv_flow_api.g_id_offset
,p_tab_set=>'TS1'
,p_name=>'Form on BC_NOTE3'
,p_page_mode=>'MODAL'
,p_step_title=>'Form on BC_NOTE3'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_javascript_code=>'var htmldb_delete_message=''"DELETE_CONFIRM_MSG"'';'
,p_overwrite_navigation_list=>'N'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'GREGSTONT@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20140418214957'
);
wwv_flow_api.create_page_plug(
 p_id=>379693078085681541+wwv_flow_api.g_id_offset
,p_plug_name=>'Form on BC_NOTE3'
,p_plug_template=>350495633504139732+wwv_flow_api.g_id_offset
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
...
wwv_flow_api.create_page_button(
 p_id=>379693332762681541+wwv_flow_api.g_id_offset
,p_button_sequence=>30
,p_button_plug_id=>379693078085681541+wwv_flow_api.g_id_offset
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_id=>350501692613139741+wwv_flow_api.g_id_offset
,p_button_image_alt=>'Apply Changes'
,p_button_position=>'REGION_TEMPLATE_CHANGE'
,p_button_condition=>'P36_NOTE_ID'
,p_button_condition_type=>'ITEM_IS_NOT_NULL'
,p_database_action=>'UPDATE'
);
wwv_flow_api.create_page_button(
 p_id=>379693553340681541+wwv_flow_api.g_id_offset
,p_button_sequence=>10
,p_button_plug_id=>379693078085681541+wwv_flow_api.g_id_offset
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_api.create_page_button(
 p_id=>379693270036681541+wwv_flow_api.g_id_offset
,p_button_sequence=>40
,p_button_plug_id=>379693078085681541+wwv_flow_api.g_id_offset
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>379693448589681541+wwv_flow_api.g_id_offset
,p_button_sequence=>20
,p_button_plug_id=>379693078085681541+wwv_flow_api.g_id_offset
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_branch(
 p_id=>379694603869681543+wwv_flow_api.g_id_offset
,p_branch_action=>'f?p=&APP_ID.:6:&SESSION.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_sequence=>1
...
wwv_flow_api.create_page_item(
 p_id=>379694840129681543+wwv_flow_api.g_id_offset
,p_name=>'P36_NOTE_ID'
,p_item_sequence=>10
,p_item_plug_id=>379693078085681541+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
,p_prompt=>'Note Id'
,p_source=>'NOTE_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>379695039893681544+wwv_flow_api.g_id_offset
,p_name=>'P36_DATE'
,p_item_sequence=>20
,p_item_plug_id=>379693078085681541+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>379695225609681544+wwv_flow_api.g_id_offset
,p_name=>'P36_TEXT'
,p_item_sequence=>30
,p_item_plug_id=>379693078085681541+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>379695421418681545+wwv_flow_api.g_id_offset
,p_name=>'P36_CONTRACT_ID'
,p_is_required=>true
,p_item_sequence=>40
,p_item_plug_id=>379693078085681541+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>379695661899681545+wwv_flow_api.g_id_offset
,p_name=>'P36_DFLEX'
,p_item_sequence=>50
,p_item_plug_id=>379693078085681541+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>379695877320681545+wwv_flow_api.g_id_offset
,p_name=>'P36_IFLEX1'
,p_item_sequence=>60
,p_item_plug_id=>379693078085681541+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>379696021352681545+wwv_flow_api.g_id_offset
,p_name=>'P36_IFLEX2'
,p_item_sequence=>70
,p_item_plug_id=>379693078085681541+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>379696297715681545+wwv_flow_api.g_id_offset
,p_name=>'P36_VFLEX1'
,p_item_sequence=>80
,p_item_plug_id=>379693078085681541+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>379696455781681546+wwv_flow_api.g_id_offset
,p_name=>'P36_VFLEX2'
,p_item_sequence=>90
,p_item_plug_id=>379693078085681541+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>379696690719681546+wwv_flow_api.g_id_offset
,p_name=>'P36_VFLEX3'
,p_item_sequence=>100
,p_item_plug_id=>379693078085681541+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>379696862089681546+wwv_flow_api.g_id_offset
,p_name=>'P36_CREATED'
,p_item_sequence=>110
,p_item_plug_id=>379693078085681541+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>379697086321681546+wwv_flow_api.g_id_offset
...
wwv_flow_api.create_page_item(
 p_id=>379697262654681547+wwv_flow_api.g_id_offset
,p_name=>'P36_ROW_VERSION_NUMBER'
,p_item_sequence=>130
,p_item_plug_id=>379693078085681541+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
,p_prompt=>'Row Version Number'
...
wwv_flow_api.create_page_item(
 p_id=>379697416230681547+wwv_flow_api.g_id_offset
,p_name=>'P36_UPDATED'
,p_item_sequence=>140
,p_item_plug_id=>379693078085681541+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>379697656483681547+wwv_flow_api.g_id_offset
...
wwv_flow_api.create_page_item(
 p_id=>379697868074681547+wwv_flow_api.g_id_offset
,p_name=>'P36_NOTE_DATE'
,p_item_sequence=>4
,p_item_plug_id=>379693078085681541+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
,p_prompt=>'Tickle Date'
,p_source=>'NOTE_DATE'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_DATE_PICKER'
,p_cSize=>32
...
wwv_flow_api.create_page_da_event(
 p_id=>379693679804681541+wwv_flow_api.g_id_offset
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>379693553340681541+wwv_flow_api.g_id_offset
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>379694018127681542+wwv_flow_api.g_id_offset
,p_event_id=>379693679804681541+wwv_flow_api.g_id_offset
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>379698237508681548+wwv_flow_api.g_id_offset
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from BC_NOTE'
,p_attribute_02=>'BC_NOTE'
,p_attribute_03=>'P36_NOTE_ID'
,p_attribute_04=>'NOTE_ID'
,p_attribute_11=>'I:U:D'
);
wwv_flow_api.create_page_process(
 p_id=>379698404822681549+wwv_flow_api.g_id_offset
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of BC_NOTE'
...
wwv_flow_api.create_page_process(
 p_id=>379698600040681549+wwv_flow_api.g_id_offset
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>379693448589681541+wwv_flow_api.g_id_offset
);
wwv_flow_api.create_page_process(
 p_id=>379698835009681549+wwv_flow_api.g_id_offset
,p_process_sequence=>50
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'GREGSTONT@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20140419045017'
);
wwv_flow_api.create_page_plug(
 p_id=>379904962772754303+wwv_flow_api.g_id_offset
,p_plug_name=>'Note'
,p_plug_template=>350495633504139732+wwv_flow_api.g_id_offset
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
...
wwv_flow_api.create_page_button(
 p_id=>379905202833754304+wwv_flow_api.g_id_offset
,p_button_sequence=>30
,p_button_plug_id=>379904962772754303+wwv_flow_api.g_id_offset
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_id=>350501692613139741+wwv_flow_api.g_id_offset
,p_button_image_alt=>'Apply Changes'
,p_button_position=>'REGION_TEMPLATE_CHANGE'
,p_button_condition=>'P37_NOTE_ID'
,p_button_condition_type=>'ITEM_IS_NOT_NULL'
,p_database_action=>'UPDATE'
);
wwv_flow_api.create_page_button(
 p_id=>379905416767754304+wwv_flow_api.g_id_offset
,p_button_sequence=>10
,p_button_plug_id=>379904962772754303+wwv_flow_api.g_id_offset
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_api.create_page_button(
 p_id=>379905144792754304+wwv_flow_api.g_id_offset
,p_button_sequence=>40
,p_button_plug_id=>379904962772754303+wwv_flow_api.g_id_offset
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>379905337109754304+wwv_flow_api.g_id_offset
,p_button_sequence=>20
,p_button_plug_id=>379904962772754303+wwv_flow_api.g_id_offset
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_branch(
 p_id=>379906523527754306+wwv_flow_api.g_id_offset
...
wwv_flow_api.create_page_item(
 p_id=>379906786270754308+wwv_flow_api.g_id_offset
,p_name=>'P37_NOTE_ID'
,p_item_sequence=>10
,p_item_plug_id=>379904962772754303+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
,p_prompt=>'Note Id'
,p_source=>'NOTE_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>379906947457754309+wwv_flow_api.g_id_offset
,p_name=>'P37_DATE'
,p_item_sequence=>20
,p_item_plug_id=>379904962772754303+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>379907159403754309+wwv_flow_api.g_id_offset
,p_name=>'P37_TEXT'
,p_item_sequence=>30
,p_item_plug_id=>379904962772754303+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>379907384024754310+wwv_flow_api.g_id_offset
...
wwv_flow_api.create_page_item(
 p_id=>379907519115754310+wwv_flow_api.g_id_offset
,p_name=>'P37_DFLEX'
,p_item_sequence=>50
,p_item_plug_id=>379904962772754303+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>379907793328754310+wwv_flow_api.g_id_offset
,p_name=>'P37_IFLEX1'
,p_item_sequence=>60
,p_item_plug_id=>379904962772754303+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>379907924998754310+wwv_flow_api.g_id_offset
,p_name=>'P37_IFLEX2'
,p_item_sequence=>70
,p_item_plug_id=>379904962772754303+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>379908183044754311+wwv_flow_api.g_id_offset
,p_name=>'P37_VFLEX1'
,p_item_sequence=>80
,p_item_plug_id=>379904962772754303+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>379908389849754311+wwv_flow_api.g_id_offset
,p_name=>'P37_VFLEX2'
,p_item_sequence=>90
,p_item_plug_id=>379904962772754303+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>379908503440754311+wwv_flow_api.g_id_offset
,p_name=>'P37_VFLEX3'
,p_item_sequence=>100
,p_item_plug_id=>379904962772754303+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>379908795346754311+wwv_flow_api.g_id_offset
,p_name=>'P37_CREATED'
,p_item_sequence=>110
,p_item_plug_id=>379904962772754303+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>379908975496754311+wwv_flow_api.g_id_offset
...
wwv_flow_api.create_page_item(
 p_id=>379909172977754312+wwv_flow_api.g_id_offset
...
wwv_flow_api.create_page_item(
 p_id=>379909321846754312+wwv_flow_api.g_id_offset
,p_name=>'P37_UPDATED'
,p_item_sequence=>140
,p_item_plug_id=>379904962772754303+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>379909591067754312+wwv_flow_api.g_id_offset
...
wwv_flow_api.create_page_item(
 p_id=>379909795867754312+wwv_flow_api.g_id_offset
,p_name=>'P37_NOTE_DATE'
,p_item_sequence=>5
,p_item_plug_id=>379904962772754303+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
,p_prompt=>'Note Date'
...
wwv_flow_api.create_page_da_event(
 p_id=>379905537392754304+wwv_flow_api.g_id_offset
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>379905416767754304+wwv_flow_api.g_id_offset
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>379905917851754305+wwv_flow_api.g_id_offset
,p_event_id=>379905537392754304+wwv_flow_api.g_id_offset
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>379910191996754313+wwv_flow_api.g_id_offset
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from BC_NOTE'
,p_attribute_02=>'BC_NOTE'
,p_attribute_03=>'P37_NOTE_ID'
,p_attribute_04=>'NOTE_ID'
,p_attribute_11=>'I:U:D'
);
wwv_flow_api.create_page_process(
 p_id=>379910392597754314+wwv_flow_api.g_id_offset
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of BC_NOTE'
...
wwv_flow_api.create_page_process(
 p_id=>379910513117754314+wwv_flow_api.g_id_offset
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>379905337109754304+wwv_flow_api.g_id_offset
);
wwv_flow_api.create_page_process(
 p_id=>379910782723754314+wwv_flow_api.g_id_offset
,p_process_sequence=>50
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'GREGSTONT@GMAIL.COM'
,p_last_upd_yyyymmddhh24miss=>'20140419053348'
);
wwv_flow_api.create_page_plug(
 p_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_plug_name=>'Form on CREO_CONTACT'
,p_plug_template=>350494745894139731+wwv_flow_api.g_id_offset
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
...
wwv_flow_api.create_page_button(
 p_id=>381366307686398181+wwv_flow_api.g_id_offset
,p_button_sequence=>30
,p_button_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_id=>350501692613139741+wwv_flow_api.g_id_offset
,p_button_image_alt=>'Apply Changes'
...
wwv_flow_api.create_page_button(
 p_id=>381366567274398181+wwv_flow_api.g_id_offset
,p_button_sequence=>10
,p_button_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_api.create_page_button(
 p_id=>381366270574398181+wwv_flow_api.g_id_offset
,p_button_sequence=>40
,p_button_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>381366424537398181+wwv_flow_api.g_id_offset
,p_button_sequence=>20
,p_button_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_branch(
 p_id=>381367607163398184+wwv_flow_api.g_id_offset
,p_branch_action=>'f?p=&APP_ID.:15:&SESSION.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_sequence=>1
...
wwv_flow_api.create_page_item(
 p_id=>381367898049398185+wwv_flow_api.g_id_offset
,p_name=>'P38_CONTACT_ID'
,p_item_sequence=>10
,p_item_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
,p_prompt=>'Contact Id'
,p_source=>'CONTACT_ID'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_api.create_page_item(
 p_id=>381368018047398185+wwv_flow_api.g_id_offset
,p_name=>'P38_INTERNAL_NAME'
,p_item_sequence=>25
,p_item_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
,p_prompt=>'Internal Name'
...
wwv_flow_api.create_page_item(
 p_id=>381368241894398186+wwv_flow_api.g_id_offset
,p_name=>'P38_TYPE'
,p_item_sequence=>30
,p_item_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>381368468694398186+wwv_flow_api.g_id_offset
,p_name=>'P38_DEPARTMENT'
,p_item_sequence=>40
,p_item_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
,p_prompt=>'Department'
...
wwv_flow_api.create_page_item(
 p_id=>381368650637398187+wwv_flow_api.g_id_offset
,p_name=>'P38_VID'
,p_item_sequence=>50
,p_item_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>381368872295398187+wwv_flow_api.g_id_offset
,p_name=>'P38_ACCOUNT_NUMBER'
,p_item_sequence=>60
,p_item_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
,p_prompt=>'Account Number'
...
wwv_flow_api.create_page_item(
 p_id=>381369016475398187+wwv_flow_api.g_id_offset
,p_name=>'P38_PRIMARY_CONTACT_NAME'
,p_item_sequence=>70
,p_item_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
,p_prompt=>'Primary Contact Name'
...
wwv_flow_api.create_page_item(
 p_id=>381369294843398188+wwv_flow_api.g_id_offset
...
wwv_flow_api.create_page_item(
 p_id=>381369452843398188+wwv_flow_api.g_id_offset
,p_name=>'P38_NAME'
,p_item_sequence=>12
,p_item_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>381369681310398188+wwv_flow_api.g_id_offset
,p_name=>'P38_TITLE'
,p_item_sequence=>13
,p_item_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>381369874485398188+wwv_flow_api.g_id_offset
,p_name=>'P38_PHONE'
,p_item_sequence=>14
,p_item_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>381370008239398189+wwv_flow_api.g_id_offset
,p_name=>'P38_FAX'
,p_item_sequence=>15
,p_item_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>381370226109398189+wwv_flow_api.g_id_offset
,p_name=>'P38_EMAIL'
,p_item_sequence=>16
,p_item_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>381370462750398189+wwv_flow_api.g_id_offset
,p_name=>'P38_ADDRESS'
,p_item_sequence=>17
,p_item_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>381370606941398189+wwv_flow_api.g_id_offset
,p_name=>'P38_CITY'
,p_item_sequence=>18
,p_item_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>381370857013398189+wwv_flow_api.g_id_offset
,p_name=>'P38_STATE'
,p_item_sequence=>19
,p_item_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>381371065604398190+wwv_flow_api.g_id_offset
,p_name=>'P38_ZIP_CODE'
,p_item_sequence=>20
,p_item_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>381371229551398190+wwv_flow_api.g_id_offset
,p_name=>'P38_COUNTRY'
,p_item_sequence=>21
,p_item_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>381371405599398191+wwv_flow_api.g_id_offset
,p_name=>'P38_DEPT_ID'
,p_is_required=>true
,p_item_sequence=>190
,p_item_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
...
wwv_flow_api.create_page_item(
 p_id=>381371644430398191+wwv_flow_api.g_id_offset
,p_name=>'P38_DFLEX'
,p_item_sequence=>200
,p_item_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>381371828986398191+wwv_flow_api.g_id_offset
,p_name=>'P38_IFLEX1'
,p_item_sequence=>210
,p_item_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>381372050773398191+wwv_flow_api.g_id_offset
,p_name=>'P38_IFLEX2'
,p_item_sequence=>220
,p_item_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>381372272107398191+wwv_flow_api.g_id_offset
,p_name=>'P38_VFLEX1'
,p_item_sequence=>230
,p_item_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>381372402543398192+wwv_flow_api.g_id_offset
,p_name=>'P38_VFLEX2'
,p_item_sequence=>240
,p_item_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>381372628554398192+wwv_flow_api.g_id_offset
,p_name=>'P38_VFLEX3'
,p_item_sequence=>250
,p_item_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>381372804417398192+wwv_flow_api.g_id_offset
,p_name=>'P38_CREATED'
,p_item_sequence=>260
,p_item_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>381373045959398193+wwv_flow_api.g_id_offset
...
wwv_flow_api.create_page_item(
 p_id=>381373284574398193+wwv_flow_api.g_id_offset
,p_name=>'P38_ROW_VERSION_NUMBER'
,p_item_sequence=>280
,p_item_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
,p_prompt=>'Row Version Number'
...
wwv_flow_api.create_page_item(
 p_id=>381373499715398193+wwv_flow_api.g_id_offset
,p_name=>'P38_UPDATED'
,p_item_sequence=>290
,p_item_plug_id=>381366092952398180+wwv_flow_api.g_id_offset
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>381373652193398193+wwv_flow_api.g_id_offset
...
wwv_flow_api.create_page_da_event(
 p_id=>381366694486398181+wwv_flow_api.g_id_offset
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>381366567274398181+wwv_flow_api.g_id_offset
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>381367074830398183+wwv_flow_api.g_id_offset
,p_event_id=>381366694486398181+wwv_flow_api.g_id_offset
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>381374040134398195+wwv_flow_api.g_id_offset
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from CREO_CONTACT'
,p_attribute_02=>'CREO_CONTACT'
,p_attribute_03=>'P38_NAME'
,p_attribute_04=>'NAME'
);
wwv_flow_api.create_page_process(
 p_id=>381374227866398196+wwv_flow_api.g_id_offset
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of CREO_CONTACT'
...
wwv_flow_api.create_page_process(
 p_id=>381374481223398196+wwv_flow_api.g_id_offset
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>381366424537398181+wwv_flow_api.g_id_offset
);
wwv_flow_api.create_page_process(
 p_id=>381374686474398196+wwv_flow_api.g_id_offset
,p_process_sequence=>50
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
