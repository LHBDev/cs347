...
CREATE TABLE  "BC_CONTRACT" 
   (	"CONTRACT_ID" NUMBER(*,0) NOT NULL ENABLE, 
	...
	"BEGINNING_DATE" DATE, 
	"ENDING_DATE" DATE, 
	"REMAINING_RENEWAL" NUMBER(*,0), 
	"REMAINING_LENGTHS" NUMBER(*,0), 
	...
	"AMENDMENT_VERSION" NUMBER(38,0), 
	"AMENDMENT_TOTAL" NUMBER(38,0), 
	"VENDOR_ID" NUMBER(38,0), 
	"DEPT_ID" NUMBER(38,0), 
	"CONTRACT_ID1" NUMBER(38,0), 
	"DEPT_ID1" NUMBER(38,0), 
	"VENDOR_ID1" NUMBER, 
	"DFLEX" DATE, 
	"IFLEX1" NUMBER(*,0), 
	"IFLEX2" NUMBER(*,0), 
	"VFLEX1" VARCHAR2(4000), 
	"VFLEX2" VARCHAR2(4000), 
	"VFLEX3" VARCHAR2(4000), 
	"CREATED" DATE, 
	"CREATED_BY" VARCHAR2(255), 
	"ROW_VERSION_NUMBER" NUMBER(*,0), 
	"UPDATED" DATE, 
	"UPDATED_BY" VARCHAR2(255), 
	 CONSTRAINT "BC_CONTRACT_PK" PRIMARY KEY ("CONTRACT_ID") ENABLE
   )
/
CREATE TABLE  "BC_DEPT" 
   (	"DEPT_ID" NUMBER(*,0) NOT NULL ENABLE, 
	...
	"UPDATED" DATE, 
	"UPDATED_BY" VARCHAR2(255), 
	 CONSTRAINT "BC_DEPARTMENT_PK" PRIMARY KEY ("DEPT_ID") ENABLE
   )
/
CREATE TABLE  "BC_NOTE" 
   (	"NOTE_ID" NUMBER NOT NULL ENABLE, 
	...
	"UPDATED_BY" VARCHAR2(255), 
	"NOTE_DATE" DATE, 
	 CONSTRAINT "BC_NOTE_PK" PRIMARY KEY ("NOTE_ID") ENABLE
   )
/
CREATE TABLE  "BC_REC_PROV" 
   (	"TYPE_ID" NUMBER, 
	"NAME" VARCHAR2(255), 
	 CONSTRAINT "BC_REC_PROV_PK" PRIMARY KEY ("TYPE_ID") ENABLE
   )
/
CREATE TABLE  "BC_SERVICE_TYPE" 
   (	"TYPE_ID" NUMBER NOT NULL ENABLE, 
	...
	"UPDATED" DATE, 
	"UPDATED_BY" VARCHAR2(255), 
	 CONSTRAINT "BC_SERVICE_TYPE_PK" PRIMARY KEY ("TYPE_ID") ENABLE
   )
/
CREATE TABLE  "BC_STATE" 
   (	"STATE_ID" NUMBER, 
	"NAME" VARCHAR2(255), 
	 CONSTRAINT "BC_STATE_PK" PRIMARY KEY ("STATE_ID") ENABLE
   )
/
CREATE TABLE  "BC_STATUS" 
   (	"STATUS_ID" NUMBER, 
	"NAME" VARCHAR2(255), 
	 CONSTRAINT "BC_STATUS_PK" PRIMARY KEY ("STATUS_ID") ENABLE
   )
/
CREATE TABLE  "BC_VENDOR" 
   (	"VENDOR_ID" NUMBER(*,0) NOT NULL ENABLE, 
	...
	"UPDATED" DATE, 
	"UPDATED_BY" VARCHAR2(255), 
	 CONSTRAINT "BC_VENDOR_PK" PRIMARY KEY ("VENDOR_ID") ENABLE
   )
/
CREATE TABLE  "CREO_COMMUNICATION" 
   (	"COMMUNICATION_ID" NUMBER(*,0) NOT NULL ENABLE, 
	"date" DATE, 
	"NOTES" VARCHAR2(4000), 
	"CREO_CONTACT_CONTACT_ID" NUMBER(*,0) NOT NULL ENABLE, 
	"DFLEX" DATE, 
	"IFLEX1" NUMBER(*,0), 
	"IFLEX2" NUMBER(*,0), 
	"VFLEX1" VARCHAR2(4000), 
	...
	"UPDATED" DATE, 
	"UPDATED_BY" VARCHAR2(255), 
	 CONSTRAINT "CREO_COMMUNICATION_PK" PRIMARY KEY ("COMMUNICATION_ID") ENABLE
   )
/
CREATE TABLE  "CREO_CONTACT" 
   (	"CONTACT_ID" NUMBER(*,0) NOT NULL ENABLE, 
	...
	"UPDATED_BY" VARCHAR2(255), 
	 ...
	 CONSTRAINT "CREO_CONTACT_PK" PRIMARY KEY ("CONTACT_ID") ENABLE
   )
/
CREATE TABLE  "CREO_COST" 
   (	"COST_ID" NUMBER(*,0) NOT NULL ENABLE, 
	...
	"ITEM_ID" NUMBER(*,0), 
	"CREO_CONTACT_CONTACT_ID" NUMBER(*,0), 
	"DFLEX" DATE, 
	"IFLEX1" NUMBER(*,0), 
	"IFLEX2" NUMBER(*,0), 
	"VFLEX1" VARCHAR2(4000), 
	...
	"UPDATED" DATE, 
	"UPDATED_BY" VARCHAR2(255), 
	 CONSTRAINT "CREO_COST_PK" PRIMARY KEY ("COST_ID") ENABLE
   )
/
CREATE TABLE  "CREO_DOCUMENT" 
   (	"ID" NUMBER(*,0) NOT NULL ENABLE, 
	...
	"UPDATED" DATE, 
	"UPDATED_BY" VARCHAR2(255), 
	 CONSTRAINT "CREO_DOCUMENT_PK" PRIMARY KEY ("ID") ENABLE
   )
/
CREATE TABLE  "CREO_ESCALATION" 
   (	"ESCALATION_ID" NUMBER(*,0) NOT NULL ENABLE, 
	"date" DATE, 
	"AMOUNT" NUMBER, 
	"PERCENTAGE" NUMBER(*,0), 
	"DESCRIPTION" VARCHAR2(100) NOT NULL ENABLE, 
	...
	"UPDATED" DATE, 
	"UPDATED_BY" VARCHAR2(255), 
	 CONSTRAINT "CREO_ESCALATION_PK" PRIMARY KEY ("ESCALATION_ID") ENABLE
   )
/
CREATE TABLE  "CREO_ISSUE" 
   (	"ISSUE_ID" NUMBER(*,0) NOT NULL ENABLE, 
	...
	"UPDATED" DATE, 
	"UPDATED_BY" VARCHAR2(255), 
	 CONSTRAINT "CREO_ISSUE_PK" PRIMARY KEY ("ISSUE_ID") ENABLE
   )
/
CREATE TABLE  "CREO_ITEM_ESC" 
   (	"ITEM_ESC_ID" NUMBER(*,0) NOT NULL ENABLE, 
	"ESCALATION_ID" NUMBER(*,0) NOT NULL ENABLE, 
	...
	"UPDATED" DATE, 
	"UPDATED_BY" VARCHAR2(255), 
	 CONSTRAINT "CREO_ITEM_ESC_PK" PRIMARY KEY ("ITEM_ESC_ID") ENABLE
   )
/
CREATE TABLE  "CREO_LEASE" 
   (	"LEASE_ID" NUMBER(*,0) NOT NULL ENABLE, 
	...
	"TOTAL_RENT" NUMBER, 
	"RENEWAL_OPTIONS_NUMBER" NUMBER(*,0), 
	"RENEWAL_OPTIONS_TERM" VARCHAR2(50), 
	"PO_NUMBER" VARCHAR2(255), 
	"CREO_CONTACT_CONTACT_ID" NUMBER(*,0), 
	"CREO_CONTACT_CONTACT_ID1" NUMBER(*,0), 
	"DFLEX" DATE, 
	"IFLEX1" NUMBER(*,0), 
	"IFLEX2" NUMBER(*,0), 
	"VFLEX1" VARCHAR2(4000), 
	...
	"UPDATED" DATE, 
	"UPDATED_BY" VARCHAR2(255), 
	 CHECK ( type IN ('ATM', 'Tower', 'UT as Landlord', 'UT as Tenant')) ENABLE, 
	 CONSTRAINT "CREO_ORD_ID_PK" PRIMARY KEY ("LEASE_ID") ENABLE
   )
/
CREATE TABLE  "CREO_LEASE_ITEM" 
   (	"ITEM_ID" NUMBER(*,0) NOT NULL ENABLE, 
	...
	"UPDATED" DATE, 
	"UPDATED_BY" VARCHAR2(255), 
	 CONSTRAINT "CREO_ITEM_ORDID_ITEMID_PK" PRIMARY KEY ("ITEM_ID") ENABLE
   )
/
CREATE TABLE  "CREO_LINK" 
   (	"LINK_ID" NUMBER(*,0) NOT NULL ENABLE, 
	...
	"UPDATED" DATE, 
	"UPDATED_BY" VARCHAR2(255), 
	 CONSTRAINT "CREO_LINK_PK" PRIMARY KEY ("LINK_ID") ENABLE
   )
/
CREATE TABLE  "CREO_PAYMENT" 
   (	"PAYMENT_ID" NUMBER(*,0) NOT NULL ENABLE, 
	...
	"UPDATED" DATE, 
	"UPDATED_BY" VARCHAR2(255), 
	 CONSTRAINT "CREO_PAYMENT_PK" PRIMARY KEY ("PAYMENT_ID") ENABLE
   )
/
CREATE TABLE  "CREO_PROPERTY" 
   (	"PROPERTY_ID" NUMBER(*,0) NOT NULL ENABLE, 
	"BUILDING" VARCHAR2(100), 
	"SPACE" VARCHAR2(255) NOT NULL ENABLE, 
	"SQUARE_FEET" NUMBER, 
	"ACREAGE" NUMBER, 
	"PRICE_PER_SF" NUMBER, 
	"ANNUAL_RENT" NUMBER, 
	...
	"UPDATED" DATE, 
	"UPDATED_BY" VARCHAR2(255), 
	 CONSTRAINT "CREO_PRODUCT_ID_PK" PRIMARY KEY ("PROPERTY_ID") ENABLE
   )
/
...
CREATE TABLE  "RELATION_30" 
   (	"BC_CONTRACT_CONTRACT_ID" NUMBER(*,0) NOT NULL ENABLE, 
	"BC_VENDOR_VENDOR_ID" NUMBER(*,0) NOT NULL ENABLE, 
	 CONSTRAINT "RELATION_30__IDX" PRIMARY KEY ("BC_CONTRACT_CONTRACT_ID", "BC_VENDOR_VENDOR_ID") ENABLE
   )
/
...
/
CREATE UNIQUE INDEX  "CREO_CONTACT__IDX" ON  "CREO_CONTACT" ("DEPT_ID")
/
...
/
CREATE UNIQUE INDEX  "SYS_IL0000540073C00007$$" ON  "DEMO_PRODUCT_INFO" (
/
CREATE UNIQUE INDEX  "SYS_IL0000540094C00007$$" ON  "APEX$_WS_WEBPG_SECTIONS" (
/
CREATE UNIQUE INDEX  "SYS_IL0000540094C00008$$" ON  "APEX$_WS_WEBPG_SECTIONS" (
/
CREATE UNIQUE INDEX  "SYS_IL0000540100C00165$$" ON  "APEX$_WS_ROWS" (
/
CREATE UNIQUE INDEX  "SYS_IL0000540100C00166$$" ON  "APEX$_WS_ROWS" (
/
CREATE UNIQUE INDEX  "SYS_IL0000540107C00007$$" ON  "APEX$_WS_NOTES" (
/
CREATE UNIQUE INDEX  "SYS_IL0000540115C00010$$" ON  "APEX$_WS_FILES" (
/
CREATE UNIQUE INDEX  "SYS_IL0000540119C00008$$" ON  "APEX$_WS_WEBPG_SECTION_HISTORY" (
/
CREATE UNIQUE INDEX  "SYS_IL0000540119C00009$$" ON  "APEX$_WS_WEBPG_SECTION_HISTORY" (
/
CREATE UNIQUE INDEX  "SYS_IL0000548902C00005$$" ON  "CREO_DOCUMENT" (
/
...
Rem No procedure found to generate DDL.
 CREATE SEQUENCE   "BC_CONTRACT_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 180 CACHE 20 NOORDER  NOCYCLE
/
 CREATE SEQUENCE   "BC_DEPT_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 240 CACHE 20 NOORDER  NOCYCLE
/
 CREATE SEQUENCE   "BC_NOTE_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 160 CACHE 20 NOORDER  NOCYCLE
/
 CREATE SEQUENCE   "BC_REC_PROV_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE
/
 CREATE SEQUENCE   "BC_SERVICE_TYPE_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 220 CACHE 20 NOORDER  NOCYCLE
/
 CREATE SEQUENCE   "BC_STATE_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 160 CACHE 20 NOORDER  NOCYCLE
/
 CREATE SEQUENCE   "BC_STATUS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 120 CACHE 20 NOORDER  NOCYCLE
/
 CREATE SEQUENCE   "BC_VENDOR_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 140 CACHE 20 NOORDER  NOCYCLE
/
 CREATE SEQUENCE   "CREO_COMMUNICATION_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 100 CACHE 20 NOORDER  NOCYCLE
/
 CREATE SEQUENCE   "CREO_CONTACT_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 120 CACHE 20 NOORDER  NOCYCLE
/
 CREATE SEQUENCE   "CREO_COST_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 100 CACHE 20 NOORDER  NOCYCLE
/
 CREATE SEQUENCE   "CREO_DOCUMENT_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 160 CACHE 20 NOORDER  NOCYCLE
/
 CREATE SEQUENCE   "CREO_ESCALATION_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 100 CACHE 20 NOORDER  NOCYCLE
/
 CREATE SEQUENCE   "CREO_ISSUE_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 100 CACHE 20 NOORDER  NOCYCLE
/
 CREATE SEQUENCE   "CREO_ITEM_ESC_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 100 CACHE 20 NOORDER  NOCYCLE
/
 CREATE SEQUENCE   "CREO_LEASE_ITEM_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 100 CACHE 20 NOORDER  NOCYCLE
/
 CREATE SEQUENCE   "CREO_LEASE_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 100 CACHE 20 NOORDER  NOCYCLE
/
 CREATE SEQUENCE   "CREO_LINK_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 100 CACHE 20 NOORDER  NOCYCLE
/
 CREATE SEQUENCE   "CREO_PAYMENT_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 100 CACHE 20 NOORDER  NOCYCLE
/
 CREATE SEQUENCE   "CREO_PROPERTY_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 100 CACHE 20 NOORDER  NOCYCLE
/
...
/
ALTER TRIGGER  "BC_CONTRACT_AUD_TRIG" ENABLE
/
CREATE OR REPLACE TRIGGER  "BC_CONTRACT_PK_TRIG" 
before insert on BC_contract
for each row 
begin 
select BC_contract_seq.currval into :new.contract_id from dual; 
end; 

/
ALTER TRIGGER  "BC_CONTRACT_PK_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "BC_DEPT_AUD_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "BC_DEPT_PK_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "BC_NOTE_AUD_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "BC_NOTE_PK_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "BC_SERVICE_TYPE_AUD_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "BC_SERVICE_TYPE_PK_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "BC_STATE_PK_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "BC_STATUS_PK_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "BC_VENDOR_AUD_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "BC_VENDOR_PK_TRIG" ENABLE
/
CREATE OR REPLACE TRIGGER  "BI_BC_REC_PROV" 
  before insert on "BC_REC_PROV"               
  for each row  
begin   
  if :NEW."TYPE_ID" is null then 
    select "BC_REC_PROV_SEQ".nextval into :NEW."TYPE_ID" from sys.dual; 
  end if; 
end; 

/
ALTER TRIGGER  "BI_BC_REC_PROV" ENABLE
/
...
/
ALTER TRIGGER  "CREO_COMMUNICATION_AUD_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "CREO_COMMUNICATION_PK_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "CREO_CONTACT_AUD_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "CREO_CONTACT_PK_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "CREO_COST_AUD_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "CREO_COST_PK_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "CREO_DOCUMENT_AUD_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "CREO_DOCUMENT_PK_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "CREO_ESCALATION_AUD_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "CREO_ESCALATION_PK_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "CREO_ISSUE_AUD_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "CREO_ISSUE_PK_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "CREO_ITEM_ESC_AUD_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "CREO_ITEM_ESC_PK_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "CREO_LEASE_AUD_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "CREO_LEASE_ITEM_AUD_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "CREO_LEASE_ITEM_PK_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "CREO_LEASE_PK_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "CREO_LINK_AUD_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "CREO_LINK_PK_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "CREO_PAYMENT_AUD_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "CREO_PAYMENT_PK_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "CREO_PROPERTY_AUD_TRIG" ENABLE
/
...
/
ALTER TRIGGER  "CREO_PROPERTY_PK_TRIG" ENABLE
/
...
/
CREATE OR REPLACE TRIGGER  "FIX_PARENT" 
BEFORE INSERT
ON BC_CONTRACT
FOR EACH ROW
DECLARE
  temp_val NUMBER;
BEGIN
 select BC_contract_seq.nextval into temp_val from dual; 
  IF :new.contract_id1 IS NULL THEN
   :new.contract_id1 := temp_val;
  END IF;
END;

/
ALTER TRIGGER  "FIX_PARENT" ENABLE
/
